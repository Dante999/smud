...
{
    std::string firstWord = ConsoleFormatter::getWordFromText(0, input);
...
{
    if(ConsoleFormatter::getWordFromText(1, input)=="")
    {
    ...
    else
    {
        ...
        std::string secondWord = ConsoleFormatter::getWordFromText(1, input);
